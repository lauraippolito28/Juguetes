...
precioFK int,
cedulaClienteFK varchar (11), 
nombreProductoFK varchar (15)
);
...
/*2.*/
select cliente.nombreCliente, cliente.cedulaCliente

/*3.*/
select producto.codigoProduto, producto.cantidad, producto.cedulaClienteFK, cliente.cedulaCliente
